...
- [Comprehensive Enhancements Mod](https://github.com/quaris628/ArtemisCosmosComprehensiveEnhancementsMod) v0.6, which includes these independent mods:
...
--- | --- | --- | --- | ---
[Unofficial Patch](https://github.com/quaris628/ArtemisCosmosUnofficialPatch) v1.14 | Yes, but there's no reason to | Unofficial Patch first, Eastern Front Mod second | Yes | The Eastern Front Mod already includes the Unofficial Patch
...
[Comprehensive Enhancements Mod](https://github.com/quaris628/ArtemisCosmosComprehensiveEnhancementsMod) v0.6 | Yes, but there's no reason to | Comprehensive Enhancements Mod first, Eastern Front Mod second | Yes | The Eastern Front Mod already includes the Comprehensive Enhancements Mod
