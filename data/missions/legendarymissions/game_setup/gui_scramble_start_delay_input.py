...
from sbs_utils.procedural.gui import gui_hide, gui_message, gui_show, gui_sub_section, gui_text
...
def _scramble_start_delay_input_update_after_delay():
    ...
    if not GAME_SETUP_DATA.is_scramble:
        ...
        gui_represent_patched(label_text)
        gui_represent_patched(start_delay_input)
