...
from sbs_utils.procedural.gui import gui_blank, gui_button, gui_hide, gui_message, gui_row, gui_text
...
def _scramble_players_start_countdown_controls_on_start_players():
    ...
    gui_represent_patched(add_30s_button)
    gui_represent_patched(time_remaining_text)
    gui_represent_patched(time_remaining_label_text)
    gui_represent_patched(scramble_now_button)
